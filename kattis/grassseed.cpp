/*
This program calculates the cost of gardening seed.

from https://open.kattis.com/problems/grassseed
...
int main()
{
  double cost, length, width, result = 0;
  int lawns;
