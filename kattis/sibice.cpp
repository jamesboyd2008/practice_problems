// from https://open.kattis.com/problems/sibice
...
Input
The first line of input contains an integer NN (1≤N≤50), the number of matches on the floor, and two integers WW and HH, the dimensions of the box (1≤W≤100, 1≤H≤100).

Each of the following NN lines contains a single integer between 1 and 1000 (inclusive), the length of one match.
...
{
  int quantity;
  double length, width, hypotenuse, match;
  vector<string> answers;

  cin >> quantity >> length >> width;
