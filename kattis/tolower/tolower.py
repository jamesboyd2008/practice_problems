# This string manipulation program compares upper and lower case strings.

# From https://open.kattis.com/problems/tolower
...
# Returns whether Anthony will solve it.
def anthonyWins(charsy):
    charsy = list(charsy)
    firstChar = charsy[0]
    charsy[0] = charsy[0].lower()
    charsy = str(charsy)
    if charsy == charsy.lower():
        return True
    return False
